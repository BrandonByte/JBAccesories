...
<?php  
	...
	if(isset($_SESSION['user_id'])){
		$records =  $Conectarbd->prepare('select Id_Usuario, Nombre, Contraseña from usuarios where Id_Usuario=:id');
...
<body>
		<div class="Contenedor">
			...
			<div>
				<?php if(!empty($user)){ ?>
				<h3 style="margin-left: 85%; margin-top: -19px; color: white;"> echo "Admin <?= $user['NombreU'] ?> </h3>
		...
		<div id="barra">
			...
			<ul>
				...
				<li><a href="" class="barra-enlace">Clientes</a></li>
				<li><a>Administracion</a>
				<li><a style="cursor: pointer;" onclick='WinOpen2("tipo_cliente.php")' class="barra-enlace">Tipo Cliente</a>
